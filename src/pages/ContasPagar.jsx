...
export default function ContasPagar() {
  ...
  // CRÍTICO: Cálculos seguros dos totais
  const totalVencidas = contasVencidas.reduce((sum, c) => sum + (parseFloat(c.valor) || 0), 0);
  const totalHoje = contasHoje.reduce((sum, c) => sum + (parseFloat(c.valor) || 0), 0);
  const totalFuturas = contasFuturas.reduce((sum, c) => sum + (parseFloat(c.valor) || 0), 0);
