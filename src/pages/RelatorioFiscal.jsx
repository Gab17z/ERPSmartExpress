...
export default function RelatorioFiscal() {
  ...
  const valorTotal = vendasFinalizadas.reduce((sum, v) => sum + v.valor_total, 0);
            ...
            <TableBody>
              {vendasFinalizadas.slice(0, 50).map((venda) => (
                <TableRow key={venda.id}>
                  ...
                  <TableCell className="text-right font-semibold">R$ {venda.valor_total.toFixed(2)}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
